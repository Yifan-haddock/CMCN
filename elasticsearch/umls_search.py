...
def search_umls(candidate: str, index = 'hpo', lang: str = 'en', field: str = 'str', num = 50, elastic_size = 50) -> dict:
    ...
    if lang == "en":
        ...
        if index == 'disorder_dictionary':
            search_url = "http://192.168.14.1:9200/umlsdisorder/train/_search"
